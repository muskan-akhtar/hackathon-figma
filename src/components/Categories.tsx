...
function Categories() {
  return (
    <div className="w-full max-w-[1920px] mt-[300px] flex flex-col gap-7">
      <h1 className="ml-0 sm:ml-[300px] font-bold text-[32px] w-full sm:w-[237px] h-[35px] leading-[35.2px]">
        Top categories
      </h1>
