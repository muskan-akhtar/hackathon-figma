    ...
    <div>
      ...
      <div className="max-w-screen-xl mx-auto mt-24 px-4 sm:px-6">
        ...
        <p className="mt-[30px] text-center text-[16px] text-[#9F9F9F] font-normal sm:w-full sm:text-sm">
          Need assistance with our services or products? Feel free to send us an email. 
          Our dedicated team is here to support you. Don’t hesitate to reach out!
        </p>
        ...
        <div className="mt-[60px] grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div className="flex flex-col px-6 space-y-8 sm:px-10">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-[20px] font-medium sm:text-[24px]">Location</h2>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-[20px] font-medium sm:text-[24px]">Contact</h2>
                <p className="text-black text-[14px] font-normal sm:text-[16px]">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-[20px] font-medium sm:text-[24px]">Office Hours</h2>
                <p className="text-black text-[14px] font-normal sm:text-[16px]">
          ...
          <div className="p-8 bg-white w-full sm:w-[635px]">
            <form action="#" method="POST">
              <div className="mb-4">
                <label htmlFor="name" className="text-[16px] font-medium sm:text-[18px]">
                  Your Name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4 mt-8">
                <label htmlFor="email" className="text-[16px] font-medium sm:text-[18px]">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              <div className="mb-4 mt-8">
                <label htmlFor="subject" className="text-[16px] font-medium sm:text-[18px]">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div className="mb-8 mt-8">
                <label htmlFor="message" className="text-[16px] font-medium sm:text-[18px]">
                  Your Message
                </label>
                <textarea
                  id="message"
                  ...
                  className="w-full h-[120px] p-6 mt-5 border border-[#9F9F9F] rounded-[10px] sm:w-[527px]"
                  rows={4}
                  required
                ></textarea>
              </div>
