    ...
    <div>
      ...
      <div className="w-full flex justify-center px-4 sm:px-8">
        <div className="w-full max-w-[1320px] flex flex-col mt-[100px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 p-5 mt-[50px] lg:mt-[100px]">
            {[
              ...
              <div
                key={index}
                className="flex flex-col gap-3 bg-[#F7F7F7] p-4 rounded-lg shadow-md"
              >
                ...
                <p className="text-left text-[14px] sm:text-[16px] leading-6">
